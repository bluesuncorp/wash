...
const (
	// ErrorEmoji for logging
	ErrorEmoji = "‼️ "
	// UnknownError for logging
	UnknownError = "⁉️ "
	// WineGlassEmoji for logging
	WineGlassEmoji = "🍷 "
	// LoopForwardArrow for logging
	LoopForwardArrow = "↪ "
	// LoopBackwardArrow for logging
	LoopBackwardArrow = "↩ "
	// ThumbsUpEmoji for logging
	ThumbsUpEmoji = "👍 "
)
